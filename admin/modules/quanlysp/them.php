...
<table border="1" width="50%" style="border-collapse: collapse;">
   <form method="POST" action="modules/quanlysp/xuly.php" enctype="multipart/form-data">
    <tr>
        <th colspan="2" class="table-header">Điền sản phẩm</th>
    </tr>
    <tr>
        <td>Tên sản phẩm</td>
    ...
    <tr class="product_add">
        <td></td>
        <td colspan="2"><input type="submit" style="width:20%; " value="Thêm sản phẩm" name="themsanpham"></td>
    </tr>
</form>
 </table>